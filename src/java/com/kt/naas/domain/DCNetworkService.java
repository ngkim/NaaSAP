...
public class DCNetworkService {

	
	private String dcsvcid; // cpsvcid character varying(11) NOT NULL, -- DC NW
	...
	private String resultmsg; // resultmsg character varying(128), -- 처리 결과 메시지
								// CONSTRAINT t_nw_service_dc_pk PRIMARY KEY
								// (cpsvcid, connid, svcid)
	private String dcid;
